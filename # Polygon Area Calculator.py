...
#       of "*". The number of lines should be equal to the height and the 
#       number of "*" in each line should be equal to the width. There should 
#       be a new line (\n) at the end of each line. If the width or height is 
#       larger than 50, this should return the string: "Too big for picture.".
#     get_amount_inside: Takes another shape (square or rectangle) as an 
#       argument. Returns the number of times the passed in shape could fit 
#       inside the shape (with no rotations). For instance, a rectangle with 
#       a width of 4 and a height of 8 could fit in two squares with sides of 4.
...
# The Square class should be a subclass of Rectangle. When a Square object 
# is created, a single side length is passed in. The __init__ method should 
...
class Rectangle:
    ...
    def __str__(self):
        ...
        string = 'Rectangle(width=' + width + ', height=' + height + ')'
        return string
